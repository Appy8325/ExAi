...
| A6 | 2026-07-11 | **Completed the detailed Supabase reconciliation required by A5.** [19-authentication-strategy.md](19-authentication-strategy.md), [20-session-strategy.md](20-session-strategy.md), [26-file-storage.md](26-file-storage.md), and [18-api-architecture.md](18-api-architecture.md) §7 now specify Supabase Auth, JWT/refresh session mechanics with the attendee hard-session control, Supabase Storage, and Supabase Realtime respectively. Their current text, plus the current stack table in §6, is the operative architecture. The A5 "pending detailed revision" statement records the interim state only and is superseded by this amendment. | Documentation reconciliation after confirming the four detailed designs were already substantively rewritten; no business rule, permission model, or roadmap scope changed. |
